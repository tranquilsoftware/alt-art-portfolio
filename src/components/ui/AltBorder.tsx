...
export function AltBorder({ children, className }: AltBorderProps) {
  return (
    <div className={cn("relative", className)}>
      ...
      <div className="absolute -top-3 -left-3 w-6 h-6 flex items-center justify-center text-primary/60 text-xl">
        <span className="animate-pulse" style={{ animationDelay: '0.2s' }}>{UNICODE_CHAR_3}</span>
      </div>
      <div className="absolute -top-3 -right-3 w-6 h-6 flex items-center justify-center text-primary/60 text-xl">
        <span className="animate-pulse" style={{ animationDelay: '0.4s' }}>{UNICODE_CHAR_3}</span>
      </div>
      <div className="absolute -bottom-3 -left-3 w-6 h-6 flex items-center justify-center text-primary/60 text-xl">
        <span className="animate-pulse" style={{ animationDelay: '0.6s' }}>{UNICODE_CHAR_3}</span>
      </div>
      <div className="absolute -bottom-3 -right-3 w-6 h-6 flex items-center justify-center text-primary/60 text-xl">
